...
class _$HomePageGetCards implements HomePageGetCards {
  const _$HomePageGetCards();

  @override
  String toString() {
    return 'HomePageEvent.getCards()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$HomePageGetCards);
  }
...
abstract class HomePageGetCards implements HomePageEvent {
  const factory HomePageGetCards() = _$HomePageGetCards;
}
